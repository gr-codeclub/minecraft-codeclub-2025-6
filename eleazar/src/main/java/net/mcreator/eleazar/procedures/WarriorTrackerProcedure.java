...
@EventBusSubscriber
public class WarriorTrackerProcedure {
	@SubscribeEvent
		...
		if (entity instanceof Monster && sourceentity instanceof Player) {
			{
				...
				_sc.getOrCreatePlayerScore(ScoreHolder.forNameOnly(_ent.getScoreboardName()), _so).set(getEntityScore("skill_warrior", entity) + 1);
			}
		}
	}
