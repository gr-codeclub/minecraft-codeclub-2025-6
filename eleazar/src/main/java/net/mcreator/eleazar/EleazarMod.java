...
@Mod("eleazar")
public class EleazarMod {
	public static final Logger LOGGER = LogManager.getLogger(EleazarMod.class);
	public static final String MODID = "eleazar";

	public EleazarMod(IEventBus modEventBus) {
