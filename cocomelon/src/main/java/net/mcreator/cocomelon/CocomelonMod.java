package net.mcreator.cocomelon;
...
@Mod("cocomelon")
public class CocomelonMod {
	public static final Logger LOGGER = LogManager.getLogger(CocomelonMod.class);
	public static final String MODID = "cocomelon";

	public CocomelonMod(IEventBus modEventBus) {
