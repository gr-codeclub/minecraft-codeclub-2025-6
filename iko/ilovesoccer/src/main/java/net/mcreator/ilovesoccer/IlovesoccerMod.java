package net.mcreator.ilovesoccer;
...
@Mod("ilovesoccer")
public class IlovesoccerMod {
	public static final Logger LOGGER = LogManager.getLogger(IlovesoccerMod.class);
	public static final String MODID = "ilovesoccer";

	public IlovesoccerMod(IEventBus modEventBus) {
