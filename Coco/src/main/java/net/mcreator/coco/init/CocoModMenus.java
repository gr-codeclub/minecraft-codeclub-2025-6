...
import net.mcreator.coco.network.MenuStateUpdateMessage;
import net.mcreator.coco.CocoMod;

import java.util.Map;

public class CocoModMenus {
	public static final DeferredRegister<MenuType<?>> REGISTRY = DeferredRegister.create(Registries.MENU, CocoMod.MODID);
	...
	public interface MenuAccessor {
		...
		default void sendMenuStateUpdate(Player player, int elementType, String name, Object elementState, boolean needClientUpdate) {
			...
			if (player instanceof ServerPlayer serverPlayer) {
				...
				if (Minecraft.getInstance().screen instanceof CocoModScreens.ScreenAccessor accessor && needClientUpdate)
