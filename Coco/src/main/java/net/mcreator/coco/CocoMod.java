...
@Mod("coco")
public class CocoMod {
	public static final Logger LOGGER = LogManager.getLogger(CocoMod.class);
	public static final String MODID = "coco";

	public CocoMod(IEventBus modEventBus) {
