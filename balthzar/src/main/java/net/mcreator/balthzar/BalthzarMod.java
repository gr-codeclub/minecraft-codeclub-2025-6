...
import net.mcreator.balthzar.init.BalthzarModTabs;
import net.mcreator.balthzar.init.BalthzarModItems;
...
@Mod("balthzar")
public class BalthzarMod {
	public static final Logger LOGGER = LogManager.getLogger(BalthzarMod.class);
	public static final String MODID = "balthzar";

	public BalthzarMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		BalthzarModBlocks.REGISTRY.register(modEventBus);
		BalthzarModItems.REGISTRY.register(modEventBus);
		BalthzarModTabs.REGISTRY.register(modEventBus);
