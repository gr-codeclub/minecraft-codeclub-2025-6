package net.mcreator.ilovefootball;
...
@Mod("ilovefootball")
public class IlovefootballMod {
	public static final Logger LOGGER = LogManager.getLogger(IlovefootballMod.class);
	public static final String MODID = "ilovefootball";

	public IlovefootballMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		IlovefootballModBlocks.REGISTRY.register(modEventBus);
