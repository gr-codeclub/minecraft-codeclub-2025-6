package net.mcreator.bigboigoober.world.features.treedecorators;
...
@EventBusSubscriber
public class DimensionFillerBcMcreatorSucksLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<DimensionFillerBcMcreatorSucksLeaveDecorator> CODEC = MapCodec.unit(DimensionFillerBcMcreatorSucksLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("bigboigoober:dimension_filler_bc_mcreator_sucks_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public DimensionFillerBcMcreatorSucksLeaveDecorator() {
		super(0.25f);
	}
