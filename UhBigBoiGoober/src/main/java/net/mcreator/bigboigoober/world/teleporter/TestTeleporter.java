...
public class TestTeleporter {
	...
	public static void registerPointOfInterest(RegisterEvent event) {
		event.register(Registries.POINT_OF_INTEREST_TYPE, registerHelper -> {
			PoiType poiType = new PoiType(ImmutableSet.copyOf(BigboigooberModBlocks.TEST_PORTAL.get().getStateDefinition().getPossibleStates()), 0, 1);
			registerHelper.register(ResourceLocation.parse("bigboigoober:test_portal"), poiType);
	...
	public TestTeleporter(ServerLevel level) {
		this.level = level;
	}
	...
	public Optional<BlockUtil.FoundRectangle> createPortal(BlockPos p_77667_, Direction.Axis p_77668_) {
		...
		BlockState blockstate = BigboigooberModBlocks.TEST_PORTAL.get().defaultBlockState().setValue(NetherPortalBlock.AXIS, p_77668_);
