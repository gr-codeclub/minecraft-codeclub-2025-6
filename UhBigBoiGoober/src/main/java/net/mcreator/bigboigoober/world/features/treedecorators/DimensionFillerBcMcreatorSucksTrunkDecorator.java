...
@EventBusSubscriber
public class DimensionFillerBcMcreatorSucksTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<DimensionFillerBcMcreatorSucksTrunkDecorator> CODEC = MapCodec.unit(DimensionFillerBcMcreatorSucksTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("bigboigoober:dimension_filler_bc_mcreator_sucks_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
