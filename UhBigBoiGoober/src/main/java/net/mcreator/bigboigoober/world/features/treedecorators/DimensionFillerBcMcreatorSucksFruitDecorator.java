...
@EventBusSubscriber
public class DimensionFillerBcMcreatorSucksFruitDecorator extends CocoaDecorator {
	public static MapCodec<DimensionFillerBcMcreatorSucksFruitDecorator> CODEC = MapCodec.unit(DimensionFillerBcMcreatorSucksFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("bigboigoober:dimension_filler_bc_mcreator_sucks_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public DimensionFillerBcMcreatorSucksFruitDecorator() {
		super(0.2f);
	}
