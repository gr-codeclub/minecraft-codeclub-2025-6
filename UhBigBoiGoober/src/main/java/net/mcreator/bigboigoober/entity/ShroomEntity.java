package net.mcreator.bigboigoober.entity;
...
import net.mcreator.bigboigoober.procedures.ShroomRightclickedOnEntityProcedure;
import net.mcreator.bigboigoober.init.BigboigooberModEntities;

public class ShroomEntity extends Animal {
	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED, ServerBossEvent.BossBarOverlay.PROGRESS);

	public ShroomEntity(EntityType<ShroomEntity> type, Level world) {
		super(type, world);
		xpReward = 100;
		setNoAi(false);
		setCustomName(Component.literal("Shroom"));
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(7, new RemoveBlockGoal(Blocks.RED_MUSHROOM_BLOCK, this, 1, (int) 5));
		...
		this.goalSelector.addGoal(12, new TemptGoal(this, 1.5, Ingredient.of(Blocks.RED_MUSHROOM.asItem()), false));
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(serverLevel, new ItemStack(Blocks.RED_MUSHROOM));
	}

	@Override
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("block.amethyst_block.chime")), 0.15f, 1);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		ShroomEntity retval = BigboigooberModEntities.SHROOM.get().create(serverWorld, EntitySpawnReason.BREEDING);
	...
	public boolean isFood(ItemStack stack) {
		return Ingredient.of(Blocks.RED_MUSHROOM.asItem(), Blocks.BROWN_MUSHROOM.asItem()).test(stack);
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(BigboigooberModEntities.SHROOM.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
