package net.mcreator.bigboigoober;
...
@Mod("bigboigoober")
public class BigboigooberMod {
	public static final Logger LOGGER = LogManager.getLogger(BigboigooberMod.class);
	public static final String MODID = "bigboigoober";

	public BigboigooberMod(IEventBus modEventBus) {
